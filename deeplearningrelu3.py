...
with graph.as_default():
  ...
  out_layer = tf.matmul(logits, weights2) + biases2
...
with tf.Session(graph=graph) as session:
  ...
  for step in range(num_steps):
    ...
    if (step % 1000 == 0):
      ...
      feed_dict1 = {tf_train_dataset : valid_dataset, tf_train_labels : valid_labels}
      ...
      feed_dict2 = {tf_train_dataset : test_dataset, tf_train_labels : test_labels}
